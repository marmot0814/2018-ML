...
while epochs:
    ...
    if output > max_output and model.evaluate(train_data, train_target)[1] > 0.8:
        max_output = output
        model.save('best.h5')

model = load_model('best.h5')
print(
    "if you throw 10000 coin in the market, you will get {0} coin in reward.".
    format(go(model, test_data, test_money)))
